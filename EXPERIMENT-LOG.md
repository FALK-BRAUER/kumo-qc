...
| E89 | Unlimited slots + $200 risk sizing | Dynamic position sizing based on kijun distance vs fixed 10% | E40d | [#118](https://github.com/FALK-BRAUER/kumo-qc/issues/118) — 💀 CATASTROPHIC 0.222 / −1.220. 44 max concurrent positions, 84% avg heat. Over-diversification destroys returns. Flat 10% sizing confirmed optimal. |
...
13. **Unlimited slots + risk-based sizing is catastrophic.** E89: $200 risk per trade with unlimited slots → 44 max concurrent positions, 84% average heat utilization. Result: Sharpe 0.222 (−1.220 vs E40d). 587 orders (vs 196 baseline). Over-diversification dilutes returns; flat 10% sizing with fixed 10 slots is the global optimum.

### Active Queue
| ID | GH | Hypothesis | Status |
|----|-----|-----------|--------|
| E40d-v3 | [#104](https://github.com/FALK-BRAUER/kumo-qc/issues/104) | VIX<30 (looser than VIX<25) | ❌ REJECTED 1.379 / −0.063 |
| E89 | [#118](https://github.com/FALK-BRAUER/kumo-qc/issues/118) | Unlimited slots + $200 risk sizing | 💀 CATASTROPHIC 0.222 / −1.220 |
...
> **Status 2026-05-28:** E46 REJECTED (weekly redundant). E47 REJECTED (sector catastrophic). E40d-v3 REJECTED (VIX<30 looser). E89 CATASTROPHIC (unlimited slots). **All experiment tracks exhausted.** E40d remains champion at 1.442 Sharpe. No further modification axes identified. Awaiting Falk directive on next phase (paper live, new research direction, or champion acceptance).
