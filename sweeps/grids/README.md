...
- **Holds:** declarative sweep definitions. `intraday_selectivity.py` — the #323 grid
  ...
  `george_context.py` — the #416 named George-context protocol: first a 6-pack validation, then
  a 30-pack in five six-variant waves (industry, watchlist carry, attention, entry, exit).
