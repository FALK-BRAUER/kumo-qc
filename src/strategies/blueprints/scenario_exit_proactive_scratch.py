"""#398/#406/#407 proof blueprint: proactive exit plus scratch-flat management.

This keeps the #386 Scenario C entry/selection stack and composes the shared PositionPathTracker with
ScratchFlatExit and ProactiveStrengthExit. It is the first George-like exit-management stack:
scratch stalled trades near flat, sell winners into strength.
"""
...
CONFIG = StrategyConfig(
    name="scenario-exit-proactive-scratch",
    version="1.0.0",
    is_fixture=True,
    ...
    phases={
        ...
        "exit_hard": [
            Slot(impl=ScratchFlatExit, params=ScratchFlatExit.Params(
                no_progress_days=3,
                min_mfe_pct=0.02,
                scratch_band_pct=0.005,
                max_loss_after_mfe_pct=0.02,
            )),
            Slot(impl=ProactiveStrengthExit, params=ProactiveStrengthExit.Params(
                target_pct=0.06,
                min_peak_pct=0.05,
