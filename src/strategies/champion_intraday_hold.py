"""champion-intraday-hold — the #270 daily-signal → intraday-confirmed execution champion.
...
from phases.entry_selection.bct_intraday_hold_confirm.bct_intraday_hold_confirm import BctIntradayHoldConfirm
...
CONFIG = StrategyConfig(
    ...
    phases={
        ...
        "entry_selection": [
            ...
            Slot(impl=BctIntradayHoldConfirm, params=BctIntradayHoldConfirm.Params()),
        ],
