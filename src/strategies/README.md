...
- **Scanner experiments:** `bct_lambdamart_scanner.py` and `bct_opportunity_ranker_scanner.py`
  are opt-in learned scanner gates and are not the production champion.
