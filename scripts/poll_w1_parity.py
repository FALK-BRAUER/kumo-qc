#!/usr/bin/env python3
"""
Poll W1 parity backtest (0a35ed3beb5042b67af0a0790ad87442) for runtime error details.
"""
...
def main():
    bt_id = "0a35ed3beb5042b67af0a0790ad87442"
    print(f"Polling W1 parity backtest {bt_id[:16]}...")
