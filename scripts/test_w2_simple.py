#!/usr/bin/env python3
"""
Test W2 with minimal warmup to debug Isolator cancellation.
"""
...
def submit_w2():
    ...
    r = qc_post('/backtests/create', {
        ...
        'backtestName': 'perf-W2',
        'parameters': {
            'start_year': '2026', 'start_month': '04', 'start_day': '14',
            'end_year': '2026', 'end_month': '04', 'end_day': '18',
            'cloud_exit': 'True',
            'weekly_kijun_exit': 'True',
            'warmup_days': '5',  # Even shorter warmup
        },
    })
...
def main():
    print("Testing W2 with warmup_days=5")
    bt_id = submit_w2()
    if bt_id:
        result = poll_w2(bt_id)
