#!/bin/bash
# C2 Resistance Proximity Gate - All 6 Windows Backtest Runner

cd /Users/falk/projects/kumo-qc

# Window 1: Jan-Jun 2025
echo "=== W1: Jan-Jun 2025 ==="
...
EOF
lean backtest algorithm/performance_bct 2>&1 | grep -E "(STATISTICS|Orders|Return|Sharpe|Win Rate|Drawdown)" | tail -15
